...
public class LeadsourceReport extends BaseDriver{
	...
	public void InsertDataOnPage ()
	{
		...
		button(btn1);
		System.out.println("SElecting Leadsource report");
		
		WebElement dropdown = driver.findElement(By.id("monthlyreport"));
		dropdown.click(); // assuming you have to click the "dropdown" to open it
		 
		driver.findElement(By.xpath("//*[@id=\"monthlyreport1\"]/li[3]/a")).click();
		System.out.println("Leadsource Report selected");
		...
		try {
		 ...
		 WebElement city = driver.findElement(By.id("leadsource"));
		 city.sendKeys("john");
